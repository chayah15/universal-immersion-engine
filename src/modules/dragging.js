...
export function initDragging() {
    ...
    const onWinStart = (e) => {
        ...
        if (t.closest(".uie-close-btn, .uie-inv-close, #uie-phone-close, #uie-settings-close, #uie-party-member-close, #uie-party-member-bg-edit, .phone-back-btn, .uie-controls, .uie-dropdown, .uie-dd-item, .uie-menu-tab, .uie-inv-icon, .fa-wand-magic-sparkles, [id*='sparkle'], button, input, select, textarea, a").length) {
            return;
        }
